...
class TestToDos:
    ...
    def test_get_all_todos(self):
        ...
        logger.info(f"Get All ToDos Response Code: {response.status_code}")
        todos = response.json()
        assert len(todos) > 0, f"Get All ToDos Length Greater Than 0: {len(todos) > 0}"
        logger.info(f"Get All ToDos Length Greater Than 0: {len(todos) > 0}")
        first_todo = todos[0]
    ...
    def test_get_todos_by_id_valid(self):
        ...
        logger.info(f"Get ToDos By ID Response Code: {response.status_code}")
        todo = response.json()
        ...
        logger.info(f"ID Requested: {id}, ToDo ID returned is: {todo["id"]}")
    ...
    def test_create_todo_valid(self):
        ...
        logger.info(f"Create ToDo Response code: {response.status_code}")
        todo = response.json()
        assert todo["userId"] == user_id, f'User ID Expected: {user_id}, User ID Returned: {todo["userId"]}'
        logger.info(f'User ID Expected: {user_id}, User ID Returned: {todo["userId"]}')
        assert todo["title"] == title, f'Title Expected: {title}, Title Returned: {todo["title"]}'
        logger.info(f'Title Expected: {title}, Title Returned: {todo["title"]}')
        assert todo["completed"] == False, f'Completed Expected: {False}, Completed Returned: {todo["completed"]}'
        logger.info(f'Completed Expected: {False}, Completed Returned: {todo["completed"]}')
    ...
    def test_partial_update_todo(self):
        ...
        logger.info(f"Partial Update ToDo Status Code: {response.status_code}")
        todo = response.json()
        assert todo["userId"] == todo_user_id, f'User ID Expected: {todo_user_id}, User ID Returned: {todo["userId"]}'
        logger.info(f'User ID Expected: {todo_user_id}, User ID Returned: {todo["userId"]}')
        assert todo["title"] == todo_title, f'Title Expected: {todo_title}, Title Returned: {todo["title"]}'
    ...
    def test_delete_todo_valid_id(self):
        ...
        logger.info(f"Delete ToDo Status Code: {response.status_code}")
    ...
    def test_mark_todo_complete(self):
        ...
        logger.info(f"Mark todo complete status code: {response.status_code}")
    ...
    def test_mark_todo_incomplete(self):
        ...
        logger.info(f"Mark todo incomplete status code: {response.status_code}")
